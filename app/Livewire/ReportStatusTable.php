...
final class ReportStatusTable extends PowerGridComponent
{
    public string $tableName = 'report-status-table-nmqu5y-table';
    ...
    {
        try {
            ReportStatus::query()->find($id)->delete();
    ...
    public function actions(ReportStatus $row): array
    {
        return [
            Button::add('edit')
                ->slot('Ubah')
