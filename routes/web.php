...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/posts', App\Livewire\Post\Index::class)
        ->name('posts.index');
    Route::get('/posts/create', App\Livewire\Post\Create::class)
        ->name('posts.create');
    Route::get('/posts/edit/{slug}', App\Livewire\Post\Edit::class)
        ->name('posts.edit');
    Route::get('/posts/show/{slug}', App\Livewire\Post\Detail::class)
        ->name('posts.show');
