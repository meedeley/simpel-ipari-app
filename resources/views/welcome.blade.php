...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center justify-content-center gap-4 mb-2 mb-lg-0">
                <a class="d-flex justify-content-center" href="https://adminmart.com/" target="_blank">
                    <img src="{{ asset('assets/images/logos/logo-adminmart.svg') }}" alt="">
                </a>
                ...
                <div class="d-none d-xl-flex align-items-center gap-3">
                    ...
                    <a href="https://adminmart.com/templates/bootstrap-admin/"
                        class="btn btn-outline-primary d-flex align-items-center gap-1 border-0 text-white px-6">
            ...
            <div class="d-lg-flex align-items-center gap-2">
                <h3 class="text-white mb-2 mb-lg-0 fs-5 text-center">Check Pro Versions</h3>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop3">
                            <div class="message-body">
                                <a target="_blank"
                                    ...
                                    <img src="{{ asset('assets/images/svgs/bt-cat-icon.svg') }}" width="20"
                                        alt="bootstrap" />
                                    Bootstrap Preview
                                </a>
                                <a target="_blank"
                                    ...
                                    class="dropdown-item d-flex align-items-center gap-2">
                                    <img src="{{ asset('assets/images/svgs/angular-cat-icon.svg') }}" width="18"
                                        alt="angular" />
                                    Angular Preview
                                </a>
                                <a target="_blank"
                                    ...
                                    class="dropdown-item d-flex align-items-center gap-2">
                                    <img src="{{ asset('assets/images/svgs/vue-cat-icon.svg') }}" width="18"
                                        alt="vue" />
                                    VueJs Preview
                                </a>
                                <a target="_blank"
                                    ...
                                    class="dropdown-item d-flex align-items-center gap-2">
                                    <img src="{{ asset('assets/images/svgs/next-cat-icon.svg') }}" width="18"
                                        alt="next" />
                                    NextJs Preview
                                </a>
                                <a target="_blank"
                                    ...
                                    class="dropdown-item d-flex align-items-center gap-2">
                                    <img src="{{ asset('assets/images/svgs/react-cat-icon.svg') }}" width="18"
                                        alt="react" />
                                    React Preview
                                </a>
                                <a target="_blank"
                                    ...
                                    class="dropdown-item d-flex align-items-center gap-2">
                                    <img src="{{ asset('assets/images/svgs/tailwindcss.svg') }}" width="18"
                                        alt="tailwind" />
                                    Tailwind Preview
                                </a>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card overflow-hidden rounded-2">
                                <div class="position-relative">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('assets/images/products/s4.jpg') }}"
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card overflow-hidden rounded-2">
                                <div class="position-relative">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('assets/images/products/s5.jpg') }}"
                                            class="card-img-top rounded-0" alt="..."></a>
                                    <a href="javascript:void(0)"
                                        class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                                        data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card overflow-hidden rounded-2">
                                <div class="position-relative">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('assets/images/products/s7.jpg') }}"
                                            class="card-img-top rounded-0" alt="..."></a>
                                    <a href="javascript:void(0)"
                                        class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                                        data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card overflow-hidden rounded-2">
                                <div class="position-relative">
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('assets/images/products/s11.jpg') }}"
                                            class="card-img-top rounded-0" alt="..."></a>
                                    <a href="javascript:void(0)"
                                        class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                                        data-bs-toggle="tooltip" data-bs-placement="top"
